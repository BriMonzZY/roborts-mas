...
class ParaCostmapInterface : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_costmap.ParaCostmapInterface) */ {
 public:
  ...
  static const int kHasDetectionLayerFieldNumber = 17;
 ...
 private:
  ...
  void set_has_has_local_static_layer();
  void clear_has_has_local_static_layer();
  void set_has_has_dynamic_obstacle_layer();
  void clear_has_has_dynamic_obstacle_layer();
  void set_has_has_detection_layer();
  void clear_has_has_detection_layer();
